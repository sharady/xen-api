...
let vdi_out_of_space = "VDI_OUT_OF_SPACE"
let vdi_not_formatted = "VDI_NOT_FORMATTED"
...
let pool_joining_host_cannot_contain_network_bond = "JOINING_HOST_CANNOT_CONTAIN_NETWORK_BOND"
